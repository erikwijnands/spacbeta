...
BasicGame.Game.prototype = {
  ...
  enemyFire:function() {
    this.shooterPool.forEachAlive(function (enemy) {
      if (this.time.now > enemy.nextShotAt && this.enemyBulletPool.countDead() > 0) {
          ...
          enemy.nextShotAt = this.time.now + BasicGame.SHOOTER_SHOT_DELAY + 100;
  ...
  setenemies:function(){
    ...
    this.shooterDelay = BasicGame.SPAWN_SHOOTER_DELAY - 200;
    //boss first
  ...
  addToScore:function(score) {
    ...
    if (this.score >= 35000 && this.bossPool.countDead()== 1) {
      this.spawnBoss();
      //this.bossApproaching = false;
      //this.game.time.events.add(Phaser.Timer.SECOND * 2, this.reviver, this);
    };    
